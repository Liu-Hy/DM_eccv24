#!/bin/bash
#SBATCH --job-name="dm_tiny_10ipc"
#SBATCH --output="stdout/2.log"
...
source activate adv
CUDA_VISIBLE_DEVICES=0 python main_DM.py --dataset TinyImageNet --data_path '/scratch/bcac/dataSet/' --model ConvNet --ipc 10 --dsa_strategy none --init real --lr_img 1 --num_exp 1 --num_eval 1
